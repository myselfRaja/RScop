...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    // Option 1: Send directly to your email via mailto
    ...
    // Option 2: WhatsApp redirect (optional)
    // const phone = "919876543210";
    // window.open(
    //   `https://wa.me/${phone}?text=Hi%20I'm%20${formData.name}%20(%20${formData.email}%20)%0A${formData.message}`,
    //   "_blank"
    // );
  };
    ...
    <section className="contact-section">
      ...
      <div className="contact-container">
        ...
        >
          <h4>Contact Info</h4>
          <p>
            <strong>Email:</strong> rajaprofessional181261@gmail.com
          </p>
          <p>
            <strong>Phone:</strong> +91 9038459931
          </p>
          <p>
            <strong>Location:</strong> New Market Area, Dharamtala, Kolkata 700100
          </p>
          <p>
